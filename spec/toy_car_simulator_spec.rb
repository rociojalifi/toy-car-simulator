...
RSpec.describe ToyCar do
  ...
  describe '#run' do
    it 'executes a sequence of instructions and returns the correct output' do
  ...
  describe '#valid_position?' do
    it 'returns true for valid positions within bounds and without obstacles' do
  ...
  describe '#move' do
    ...
    it 'sets crashed status when hitting an obstacle or moving out of limits' do
      car.send(:move, 5)
